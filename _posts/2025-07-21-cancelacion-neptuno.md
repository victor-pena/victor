---
title: "La cancelación del proyecto Neptuno y la política hídrica Uruguaya"
...
La reciente decisión del Poder Ejecutivo uruguayo de cancelar el denominado Proyecto Neptuno, que preveía la construcción de una planta potabilizadora cerca a la localidad de Arazatí, y la consecuente invitación al mismo consorcio adjudicatario para participar en una nueva obra en otro lugar, Aguas Corrientes, genera preocupaciones tanto desde el plano jurídico como político.

Se hacen notorias las eventuales irregularidades jurídicas en el procedimiento, así como la continuidad de un modelo de gobernanza hídrica orientado a la financiarización y privatización parcial de los bienes comunes, con independencia de los cambios de administración política.
...
Las contrataciones públicas en Uruguay se rigen por el **TOCAF** (Texto Ordenado de Contabilidad y Administración Financiera) y los principios generales de la contratación administrativa: legalidad, transparencia, competencia y finalidad. Esto implica que:
...
La única vía legal para que el mismo consorcio participe sin licitación podría ser:
...
El gobierno de Orsi no cuestiona el modelo de financiamiento multilateral, obra pública tercerizada y concesión parcial del manejo del agua, sino que:

* Reemplaza un proyecto social y ambientalmente conflictivo por otro que minimiza la protesta.
* Mantiene los nexos con el capital contratista nacional (Saceem y asociados), que impone sus propias condicionalidades, sobretodo la amenaza de reclamos ante el CIAD.

### 3.2. La oposición del Partido Nacional

El PN[^1] realiza un señalamiento jurídico válido sobre la reasignación irregular de fondos y obras. Sin embargo, su cuestionamiento no apunta al modelo en sí, sino al desplazamiento de su proyecto político empresarial** por el nuevo diseño del FA.
...
La crítica de fondo debe centrarse en cómo el mito de las instituciones fuertes sirve para naturalizar la mercantilización de bienes esenciales como el agua, mientras la flexibilidad institucional se activa discretamente para preservar los acuerdos de poder bajo el disfraz del orden jurídico.

#### Referencia

[^1]: <https://www.ambito.com/uruguay/la-oposicion-reune-sus-directorios-analizar-la-cancelacion-del-proyecto-neptuno-arazati-n6169274>
