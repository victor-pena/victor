...
Los intentos por imponer la orden a traves de la zonificación o el financiamiento de vivienda de bajo costo se orientan a configurar a un sujeto consumidor de las hipotecas.
El discurso racional ha sido pensado por un grupo particular y tiene el proposito de facilitar la tarea de gobierno; el ciudadano sujeto de prestamo es el sujeto al que se quiere disciplinar, para maximizar los recursos invertidos por el estado y por el sector financiero.
