...
“To be contemporary is to hold one’s gaze on what cannot be seen —
the light that ceaselessly withdraws.”
— Giorgio Agamben, What Is the Contemporary?[^1]

---

Peruvian politics does not collapse because it recomposes itself.
Each impeachment, each scandal, each resignation does not destroy the state; it redistributes the state, creating a new ontology of the state as a flux.
When Boluarte is removed — as Castillo, Vizcarra, and Kuczynski were before her — the country does not reveal its fragility but its particular mode of endurance. It may be theorized as *an immanent republic*, a polity that lives within its own instability.
